...
function RoomPage() {
  ...
  return (
    <main className="min-h-dvh w-full flex flex-col     bg-background_light dark:bg-background_dark text-text_light dark:text-text_dark  sm:px-5 sm:py-5 py-2 px-2">
      ...
      <section className=" flex-1 flex md:flex-row flex-col  rounded-md gap-6 dark:bg-background_dark bg-background_light dark:text-white text-text_light p-3 sm:p-5">
        <CreateRoomSection />
