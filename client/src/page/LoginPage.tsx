...
function LoginPage() {
  ...
  return (
    <main className="h-dvh w-full flex flex-col gap-3  bg-background_light dark:bg-background_dark text-text_light dark:text-text_dark  px-5 sm:px-7 sm:py-7 py-5 ">
      <Navbar />
