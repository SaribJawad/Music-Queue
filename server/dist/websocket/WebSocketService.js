          ...
          __awaiter(this, void 0, void 0, function* () {
            ...
            try {
              ...
              const isActiveElsewhere =
                yield this.checkUserActiveInOtherSessions(String(user._id));
              ...
              if (user === null || user === void 0 ? void 0 : user.isAlive) {
                ...
                //   }
                if (!room) return;
                const activeRoomSession = RoomService.rooms.get(
                  String(room._id)
                );
                if (
                  ((_a = room.songQueue) === null || _a === void 0
                    ? void 0
                    : _a.length) >= 1
                ) {
                ...
                activeRoomSession === null || activeRoomSession === void 0
                  ? void 0
              ...
              if (
                user === null || user === void 0 ? void 0 : user.isJoined.status
              ) {
                ...
                if (activeRoomSession) {
                  this.sendMessageToEveryoneExpectSenderInRoom(
                    ...
                    "LEFT_ROOM",
                    {
                      ...
                      noOfJoinedUsers:
                        connectedClients === null || connectedClients === void 0
                          ? void 0
                  ...
                  (_c = RoomService.rooms.get(String(room._id))) === null ||
                  _c === void 0
                    ? void 0
                    : _c.users.delete(ws);
                }
